...
import com.zetcode.Breakout;



public class Ladrillitos extends Frame implements WindowListener,  MouseListener, MouseMotionListener {
    ...
    // INICIALIZO GAME LOOP
    timer = new Timer();
    timer.scheduleAtFixedRate(new ScheduleTask(), 1000, 30);
    ...
    public void dibujar(Color [] colores){
       ...
       if ((py<74) && (py>56)){
        ...
        private class ScheduleTask extends TimerTask {
            ...
            if (score != 300)
            {	
            	mover(); //que nos sirve para el rebote de la pelota y para saber si paso sobre un ladrillito    
            	dibujar(colores); //dibuja todo (seria bueno hacerlo por parte para manejar mejor el tema de thread)
                //repaint();
            }
            }
        } 
